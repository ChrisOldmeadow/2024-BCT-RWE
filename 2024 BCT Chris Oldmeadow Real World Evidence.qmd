...
-   State-wide administrative datasets
    ...
    -   important clinical details (eg performance status, comorbidity, data on treatment including rational as well as key pathological features) are frequently poorly documented
...
## Example: bevacizumab added to paclitaxel in HER2-negative MBC 
